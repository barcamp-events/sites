...
const Markdown = class {
    ...
    render() {
        if (this.editable) {
            return h("stellar-card", null, h("section", null, h("copy-wrap", { full: true, class: "wrap" }, h("div", { innerHTML: this.converted }))), h("footer", { class: "bg-theme-base0" }, h("stellar-input", { type: "textarea", default: this.codeString, onUpdate: (e) => { this.codeString = e.detail; this.convert(); } })));
        }
        else {
