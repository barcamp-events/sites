...
export class PasswordRequirements {
    ...
    renderLength() {
        return h("p", { class: `${this.fs} flex items-center mb3 pa0 ma0 ${this.length ? 'theme-green' : 'theme-red'}` },
    ...
    renderUppercase() {
        return h("p", { class: `${this.fs} flex items-center mb3 pa0 ma0 ${this.uppercase ? 'theme-green' : 'theme-red'}` },
    ...
    renderNumber() {
        return h("p", { class: `${this.fs} flex items-center mb3 pa0 ma0 ${this.number ? 'theme-green' : 'theme-red'}` },
    ...
    renderSymbol() {
        return h("p", { class: `${this.fs} flex items-center mb3 pa0 ma0 ${this.symbol ? 'theme-green' : 'theme-red'}` },
    ...
    renderCommonPasswords() {
        return h("p", { class: `${this.fs} flex items-center mb3 pa0 ma0 ${this.commonPasswords ? 'theme-green' : 'theme-red'}` },
    ...
    renderCommonNames() {
        return h("p", { class: `${this.fs} flex items-center mb3 pa0 ma0 ${this.commonNames ? 'theme-green' : 'theme-red'}` },
    ...
    renderRepeatedKeys() {
        return h("p", { class: `${this.fs} flex items-center mb3 pa0 ma0 ${this.repeated ? 'theme-green' : 'theme-red'}` },
