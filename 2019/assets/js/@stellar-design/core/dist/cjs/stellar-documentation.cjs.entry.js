...
const DocumentationRoot = class {
    ...
    render() {
        ...
        return (core.h(dependencies.Tunnel.Provider, { state: tunnelState }, core.h("stencil-router", null, core.h("stencil-route-switch", { scrollTopOffset: 0 }, core.h("stencil-route", { url: '/component/:name', component: 'stellar-docs-component' }), core.h("stencil-route", { url: '/:name', component: 'stellar-docs-page', exact: true }), core.h("stencil-route", { url: '/', component: 'stellar-docs-home', exact: true }), core.h("stencil-route", { component: "stellar-docs-not-found" })))));
    }
    static get style() { return ""; }
};

exports.stellar_documentation = DocumentationRoot;
