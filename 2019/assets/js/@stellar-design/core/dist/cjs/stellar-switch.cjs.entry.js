...
const Switch = class {
    ...
    render() {
        return (core.h("label", { class: "label" }, core.h("input", { type: "checkbox", name: this.name, checked: this.checked, tabindex: "-1", onClick: () => { this.activate(); } }), core.h("button", { type: "button", onClick: () => { this.activate(); } }, core.h("span", null, this.checked && core.h("stellar-asset", { name: "checkmark" }), !this.checked && core.h("stellar-asset", { name: "close" }))), core.h("slot", null)));
    }
...
theme.Tunnel.injectProps(Switch, ['dark']);
