...
theme.Tunnel.injectProps(Accordion, ['dark']);
...
const AnimateText = class {
    ...
    componentWillLoad() {
        ...
        this.letters.forEach((e, i) => {
            cssCustomProperties_min.properties.set({ "--iteration": ((i - 1) <= 0) ? 0 : (i - 2) }, e);
        });
    }
    async in() {
    ...
    render() {
        return core.h(core.Host, { role: "text", ariaLabel: this.originalText }, core.h("slot", null), core.h("stellar-intersection", { element: this.element, multiple: true, in: this.in.bind(this), out: this.out.bind(this) }));
    }
    get element() { return core.getElement(this); }
...
theme.Tunnel.injectProps(Card, ['dark']);
