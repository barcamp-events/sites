...
const Content = class {
    ...
    render() {
        return (core.h("div", { class: "wrap", role: "tabpanel", "aria-hidden": !this.open ? "true" : "false" }, core.h("slot", null)));
    }
...
const Tab = class {
    ...
    renderNotifications() {
        return this.notifications && core.h("stellar-tag", null, this.notifications);
    }
    renderTitle() {
        return core.h("span", { class: "title" }, core.h("slot", null));
    }
    renderButton() {
        return (core.h("button", { role: "tab", type: "button", disabled: this.disabled, "aria-selected": this.open ? "true" : "false", "aria-setsize": this.tabCount, "aria-posinset": this.order, tabindex: "0", class: "tab-button", onClick: (e) => this.handleClick(e) }, this.renderNotifications(), this.renderTitle()));
    }
    renderLink() {
        return (core.h("a", { role: "tab", href: this.href, target: this.target, class: "tab-button", "data-disabled": this.disabled, onClick: (e) => { this.handleClick(e); } }, this.renderNotifications(), this.renderTitle()));
    }
    renderAppLink() {
        return (core.h("stencil-route-link", { role: "tab", url: this.href, anchorClass: "tab-button", "data-disabled": this.disabled, onClick: (e) => { this.handleClick(e); } }, this.renderNotifications(), this.renderTitle()));
    }
    render() {
        return core.h("div", { class: "tab-wrap" }, this.tag === "button" && this.renderButton(), this.tag === "link" && this.renderLink(), this.tag === "route-link" && this.renderAppLink());
    }
    get element() { return core.getElement(this); }
...
theme.Tunnel.injectProps(Tab, ['dark']);
...
const Tabs = class {
    ...
    render() {
        return (core.h("div", { class: "tab-wrap" }, core.h("div", { class: "tab-list", role: "tablist" }, core.h("slot", null), core.h("stellar-blur", { horizontal: !this.vertical ? this.blur : 0, vertical: this.vertical ? this.blur : 0 }, core.h("div", { class: "indicator" })))));
    }
    get element() { return core.getElement(this); }
...
theme.Tunnel.injectProps(Tabs, ['dark']);
