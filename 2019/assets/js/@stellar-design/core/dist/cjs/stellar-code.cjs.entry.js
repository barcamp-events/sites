...
var prismNormalizeWhitespace = _commonjsHelpers.createCommonjsModule(function (module) {
(function() {
...
const Code = class {
    ...
    renderPreview() {
        return core.h("section", { class: "preview flush" }, core.h("div", { class: "result", innerHTML: this.raw }));
    }
    renderCode() {
        return core.h("pre", { "aria-label": `The ${this.language} code`, tabindex: 0 }, core.h("code", { class: `language-${this.language}`, innerHTML: this.code }), core.h("div", { class: "hidden" }, core.h("slot", null, core.h("template", null, core.h("p", null, "There's no code here!")))));
    }
    render() {
        if (this.simple) {
            ...
            return core.h("stellar-card", { shadow: "light", padding: "small" }, this.feature && core.h("header", null, core.h("slot", { name: "feature" }), core.h("slot", { name: "property" })), this.preview && this.renderPreview(), core.h("footer", { class: "code" }, this.renderCode()));
        }
    }
