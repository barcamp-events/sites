...
const Dropdown = class {
    ...
    render() {
        return core.h(core.Host, { "aria-label": this.label, class: "dropdown", title: this.label }, core.h("div", { class: "toggle" }, core.h("slot", { name: "handle" }), this.icon && core.h("stellar-asset", { name: this.iconName, class: "caret" })), core.h("div", { class: "clipper" }, core.h("div", { class: "list-wrap" }, core.h("ul", { class: "list" }, core.h("slot", null), this.footer && core.h("div", { class: "footer" }, core.h("slot", { name: "footer" }))))));
    }
...
theme.Tunnel.injectProps(Item, ['dark']);
if (injectHistory) {
    injectHistory(Item);
}
