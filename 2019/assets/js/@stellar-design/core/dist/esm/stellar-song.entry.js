...
import { r as relPathAsAbs, l as leadingZeroIndex } from './index-9d3b27e3.js';
...
const Song = class {
    ...
    render() {
        return (h("button", { onClick: () => this.play() }, h("span", { class: "index" }, !this.playing && leadingZeroIndex(this._index), this.playing && h("stellar-asset", { name: "play" })), h("div", { class: "tracklisting" }, this.artwork && h("img", { src: this.picture, class: "preview-image" }), h("h2", null, h("span", null, this.title || "Loading..."), " / ", this.artist || "Loading...")), h("img", { src: this.picture, class: "backdrop" })));
    }
