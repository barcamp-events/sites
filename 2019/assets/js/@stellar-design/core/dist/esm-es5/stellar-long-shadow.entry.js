...
var LongShadow = /** @class */ (function () {
    ...
    Object.defineProperty(class_1, "style", {
        get: function () { return ":host,:host ::slotted(*){text-shadow:var(--text-shadow);-webkit-transition:text-shadow .35s var(--ease) .35s;transition:text-shadow .35s var(--ease) .35s}"; },
        enumerable: true,
        configurable: true
    });
    return class_1;
