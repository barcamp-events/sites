...
var sister = Sister;
var Linear = function (time, beginningValue, changeValue, duration) {
    return beginningValue + (changeValue * (time / duration));
};
var calculateValue = function (startValue, endValue, ease, duration, progress) {
    /**
    ...
    if (typeof startValue === 'string' || typeof endValue === 'string') {
        var _c = CSS_UNIT.match(startValue), start = _c[0], unit = _c[1];
        var end = CSS_UNIT.match(endValue)[0];
    }
...
var updateValue = function (ref) {
    if (ref.startValue instanceof Object) {
        var nextValue_1 = {};
        Object.keys(ref.startValue).forEach(function (key) {
            nextValue_1[key] = calculateValue(ref.startValue[key], ref.endValue[key], ref.ease, ref.duration, ref.progress);
        });
        ref.value = nextValue_1;
        return;
    }
...
var Tween = /** @class */ (function () {
    function Tween(_c) {
        var start = _c.start, end = _c.end, _d = _c.duration, duration = _d === void 0 ? 1000 : _d, _e = _c.ease, ease = _e === void 0 ? Linear : _e, _f = _c.delay, delay = _f === void 0 ? 0 : _f;
...
var In = function (time, beginningValue, changeValue, duration) {
    var s = 1.70158;
    return changeValue * (time /= duration) * time * ((s + 1) * time - s) + beginningValue;
};
var Out = function (time, beginningValue, changeValue, duration) {
    var s = 1.70158;
    return changeValue * ((time = time / duration - 1) * time * ((s + 1) * time + s) + 1) + beginningValue;
};
var InOut = function (time, beginningValue, changeValue, duration) {
    var s = 1.70158;
...
var Out$1 = function (time, beginningValue, changeValue, duration) {
...
var In$1 = function (time, beginningValue, changeValue, duration) {
    return changeValue - bounceEaseOut(duration - time, 0, changeValue, duration) + beginningValue;
};
var InOut$1 = function (time, beginningValue, changeValue, duration) {
    if (time < duration / 2) {
...
var In$2 = function (time, beginningValue, changeValue, duration) {
    return -changeValue * (Math.sqrt(1 - (time /= duration) * time) - 1) + beginningValue;
};
var Out$2 = function (time, beginningValue, changeValue, duration) {
    return changeValue * Math.sqrt(1 - (time = time / duration - 1) * time) + beginningValue;
};
var InOut$2 = function (time, beginningValue, changeValue, duration) {
    if ((time /= duration / 2) < 1) {
...
var In$3 = function (time, beginningValue, changeValue, duration) {
    return changeValue * (time /= duration) * time * time + beginningValue;
};
var Out$3 = function (time, beginningValue, changeValue, duration) {
    return changeValue * ((time = time / duration - 1) * time * time + 1) + beginningValue;
};
var InOut$3 = function (time, beginningValue, changeValue, duration) {
    if ((time /= duration / 2) < 1) {
...
var In$4 = function (time, beginningValue, changeValue, duration) {
    var s = 1.70158;
    var p = 0;
    var a = changeValue;
    if (time === 0) {
...
var Out$4 = function (time, beginningValue, changeValue, duration) {
    var s = 1.70158;
    var p = 0;
    var a = changeValue;
    if (time === 0) {
...
var InOut$4 = function (time, beginningValue, changeValue, duration) {
    var s = 1.70158;
    var p = 0;
    var a = changeValue;
    if (time === 0) {
...
var In$5 = function (time, beginningValue, changeValue, duration) {
    return (time === 0)
        ? beginningValue
        : changeValue * Math.pow(2, 10 * (time / duration - 1)) + beginningValue;
};
var Out$5 = function (time, beginningValue, changeValue, duration) {
    return (time === duration)
        ? beginningValue + changeValue
        : changeValue * (-Math.pow(2, -10 * time / duration) + 1) + beginningValue;
};
var InOut$5 = function (time, beginningValue, changeValue, duration) {
    if (time === 0) {
        return beginningValue;
    }
    if (time === duration) {
...
var In$6 = function (time, beginningValue, changeValue, duration) {
    return changeValue * (time /= duration) * time + beginningValue;
};
var Out$6 = function (time, beginningValue, changeValue, duration) {
    return -changeValue * (time /= duration) * (time - 2) + beginningValue;
};
var InOut$6 = function (time, beginningValue, changeValue, duration) {
    if ((time /= duration / 2) < 1) {
...
var In$7 = function (time, beginningValue, changeValue, duration) {
    return changeValue * (time /= duration) * time * time * time + beginningValue;
};
var Out$7 = function (time, beginningValue, changeValue, duration) {
    return -changeValue * ((time = time / duration - 1) * time * time * time - 1) + beginningValue;
};
var InOut$7 = function (time, beginningValue, changeValue, duration) {
    if ((time /= duration / 2) < 1) {
...
var In$8 = function (time, beginningValue, changeValue, duration) {
    return changeValue * (time /= duration) * time * time * time * time + beginningValue;
};
var Out$8 = function (time, beginningValue, changeValue, duration) {
    return changeValue * ((time = time / duration - 1) * time * time * time * time + 1) + beginningValue;
};
var InOut$8 = function (time, beginningValue, changeValue, duration) {
    if ((time /= duration / 2) < 1) {
...
var In$9 = function (time, beginningValue, changeValue, duration) {
    return -changeValue * Math.cos(time / duration * (Math.PI / 2)) + changeValue + beginningValue;
};
var Out$9 = function (time, beginningValue, changeValue, duration) {
    return changeValue * Math.sin(time / duration * (Math.PI / 2)) + beginningValue;
};
var InOut$9 = function (time, beginningValue, changeValue, duration) {
...
var parentNodeSelector = function (element, parentselector) {
    ...
    var selectors = parentselector.split(/(?=[#\.])/), tagname = selectors.shift();
        ...
        function selectorMatchAll(selectors) {
            ...
            function selectorMatch(selector) {
                ...
                switch (selectorparts[0]) {
                    case '#':
                        return selectorparts[1].toLowerCase() === et.id.toLowerCase();
                        break;
                    case '.':
                        return et.className.match(selregex);
                        break;
                }
            }
        }
...
/*! medium-zoom 1.0.4 | MIT License | https://github.com/francoischalifour/medium-zoom */ var _extends = Object.assign || function (a) { for (var b, c = 1; c < arguments.length; c++)
    for (var d in b = arguments[c], b)
        Object.prototype.hasOwnProperty.call(b, d) && (a[d] = b[d]); return a; }, isSupported = function (a) { return 'IMG' === a.tagName; }, isNodeList = function (a) { return NodeList.prototype.isPrototypeOf(a); }, isNode = function (a) { return a && 1 === a.nodeType; }, isSvg = function (a) { var b = a.currentSrc || a.src; return '.svg' === b.substr(-4).toLowerCase(); }, getImagesFromSelector = function (a) { try {
...
} }, createOverlay = function (a) { var b = document.createElement('div'); return b.classList.add('medium-zoom-overlay'), b.style.background = a, b; }, cloneTarget = function (a) { var b = a.getBoundingClientRect(), c = b.top, d = b.left, e = b.width, f = b.height, g = a.cloneNode(), h = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0, i = window.pageXOffset || document.documentElement.scrollLeft || document.body.scrollLeft || 0; return g.removeAttribute('id'), g.style.position = 'absolute', g.style.top = c + h + 'px', g.style.left = d + i + 'px', g.style.width = e + 'px', g.style.height = f + 'px', g.style.transform = '', g; }, createCustomEvent = function (a, b) { var c = _extends({ bubbles: !1, cancelable: !1, detail: void 0 }, b); if ('function' == typeof window.CustomEvent)
    return new CustomEvent(a, c); var d = document.createEvent('CustomEvent'); return d.initCustomEvent(a, c.bubbles, c.cancelable, c.detail), d; }, mediumZoom = function a(b) { var c = 1 < arguments.length && arguments[1] !== void 0 ? arguments[1] : {}, d = window.Promise || function (a) { function b() { } a(b, b); }, e = function (a) { var b = a.target; return b === x ? void n() : void (-1 === r.indexOf(b) || o({ target: b })); }, f = function () { if (!t && w.original) {
    var a = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0;
    Math.abs(u - a) > v.scrollOffset && setTimeout(n, 150);
} }, g = function () { var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, b = a; if (a.background && (x.style.background = a.background), a.container && a.container instanceof Object && (b.container = _extends({}, v.container, a.container)), a.template) {
    var c = isNode(a.template) ? a.template : document.querySelector(a.template);
    b.template = c;
} return v = _extends({}, v, b), r.forEach(function (a) { a.dispatchEvent(createCustomEvent('medium-zoom:update', { detail: { zoom: y } })); }), y; }, h = function () { var b = 0 < arguments.length && arguments[0] !== void 0 ? arguments[0] : {}; return a(_extends({}, v, b)); }, i = function () { for (var a = arguments.length, b = Array(a), c = 0; c < a; c++)
    b[c] = arguments[c]; var d = b.reduce(function (a, b) { return [].concat(a, getImagesFromSelector(b)); }, []); return d.filter(function (a) { return -1 === r.indexOf(a); }).forEach(function (a) { r.push(a), a.classList.add('medium-zoom-image'); }), s.forEach(function (a) { var b = a.type, c = a.listener, e = a.options; d.forEach(function (a) { a.addEventListener(b, c, e); }); }), y; }, j = function () { for (var a = arguments.length, b = Array(a), c = 0; c < a; c++)
    b[c] = arguments[c]; w.zoomed && n(); var d = 0 < b.length ? b.reduce(function (a, b) { return [].concat(a, getImagesFromSelector(b)); }, []) : r; return d.forEach(function (a) { a.classList.remove('medium-zoom-image'), a.dispatchEvent(createCustomEvent('medium-zoom:detach', { detail: { zoom: y } })); }), r = r.filter(function (a) { return -1 === d.indexOf(a); }), y; }, k = function (a, b) { var c = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}; return r.forEach(function (d) { d.addEventListener('medium-zoom:' + a, b, c); }), s.push({ type: 'medium-zoom:' + a, listener: b, options: c }), y; }, l = function (a, b) { var c = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}; return r.forEach(function (d) { d.removeEventListener('medium-zoom:' + a, b, c); }), s = s.filter(function (c) { return c.type !== 'medium-zoom:' + a || c.listener.toString() !== b.toString(); }), y; }, m = function () { var a = 0 < arguments.length && arguments[0] !== void 0 ? arguments[0] : {}, b = a.target, c = function () { var a = Math.min, b = { width: document.documentElement.clientWidth, height: document.documentElement.clientHeight, left: 0, top: 0, right: 0, bottom: 0 }, c = void 0, d = void 0; if (v.container)
    if (v.container instanceof Object)
        b = _extends({}, b, v.container), c = b.width - b.left - b.right - 2 * v.margin, d = b.height - b.top - b.bottom - 2 * v.margin;
    else {
        var e = isNode(v.container) ? v.container : document.querySelector(v.container), f = e.getBoundingClientRect(), g = f.width, h = f.height, i = f.left, j = f.top;
        b = _extends({}, b, { width: g, height: h, left: i, top: j });
    } c = c || b.width - 2 * v.margin, d = d || b.height - 2 * v.margin; var k = w.zoomedHd || w.original, l = isSvg(k) ? c : k.naturalWidth || c, m = isSvg(k) ? d : k.naturalHeight || d, n = k.getBoundingClientRect(), o = n.top, p = n.left, q = n.width, r = n.height, s = a(l, c) / q, t = a(m, d) / r, u = a(s, t), x = (-p + (c - q) / 2 + v.margin + b.left) / u, y = (-o + (d - r) / 2 + v.margin + b.top) / u, z = 'scale(' + u + ') translate3d(' + x + 'px, ' + y + 'px, 0)'; w.zoomed.style.transform = z, w.zoomedHd && (w.zoomedHd.style.transform = z); }; return new d(function (a) { if (b && -1 === r.indexOf(b))
    return void a(y); if (w.zoomed)
    return void a(y); if (b)
    w.original = b;
else if (0 < r.length) {
    var d = r;
    w.original = d[0];
    ...
    return void a(y); if (w.original.dispatchEvent(createCustomEvent('medium-zoom:open', { detail: { zoom: y } })), u = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0, t = !0, w.zoomed = cloneTarget(w.original), document.body.appendChild(x), v.template) {
...
var blurringEase = function (args) {
    var ease = {
    ...
    tweenForward.on('tick', function (cb_args) {
        args.tick(cb_args);
    });
    tweenForward.on('complete', function () {
        tweenBackward.start();
        tweenForward.progress = 0;
    });
    tweenBackward.on('tick', function (cb_args) {
        args.tick(cb_args);
    });
    tweenBackward.on('complete', function (cb_args) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _c.label = 1;
                case 1:
                    if (!(index_1 < array.length)) return [3 /*break*/, 4];
                    return [4 /*yield*/, callback(array[index_1], index_1, array)];
                case 2:
                    _c.sent();
                    _c.label = 3;
                case 3:
...
function form2js(data) {
    ...
    data.forEach(function (item) {
        if (item.name && item.value && item.value !== "") {
            var result = convert(item.name, item.value);
            object = umd.all([object, result]);
        }
    });
    return object;
}
var asTime = function (float) {
    var sec_num = float;
...
var leadingZeroIndex = function (index) {
    var s = index + "";
    while (s.length < 2)
        s = "0" + s;
    return s;
};
var relPathAsAbs = function (sRelPath) {
...
export { index as R, tinyDatePicker as T, asTime as a, blurringEase as b, colors as c, delay as d, asyncForEach as e, focusWithin as f, form2js as g, umd as h, assertString_1 as i, isHexColor_1 as j, leadingZeroIndex as l, mediumZoom as m, parentNodeSelector as p, relPathAsAbs as r, shuffle as s, titleCase as t };
