...
var Chart = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.TimeState = function (time) { return ({
    ...
    class_1.prototype.handleTime = function () {
        var now = new Date();
        this.timeState = this.TimeState(now.getHours());
    };
    class_1.prototype.handleWeather = function () {
        var _this = this;
        var icon;
        if (sessionStorage.weather !== undefined) {
            ...
            navigator.geolocation.getCurrentPosition(function (position) { return __awaiter(_this, void 0, void 0, function () {
                var lat, lng, url, result, json;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            lat = position.coords.latitude;
                            lng = position.coords.longitude;
                            url = "https://cors-anywhere.herokuapp.com/https://api.darksky.net/forecast/" + this.apikey + "/" + lat + "," + lng;
