...
var DocsHeader = /** @class */ (function () {
    ...
    DocsHeader.prototype.handleTheming = function () {
    ...
    DocsHeader.prototype.render = function () {
        var _this = this;
        return this.ready && [
            h("stellar-message", { striped: true, type: "alert", size: "full" }, h("stellar-asset", { name: "happy" }), h("p", null, "Stellar is still an alpha product - some things may change! We'll do out best to notify you when something changes."), h("stellar-button", { size: "tiny", pill: true }, "See change log ", h("stellar-asset", { name: "arrow-forward", align: "right" }))),
            h("stellar-layout", { size: "large", class: "relative mb5", type: "sidebar-right" }, h("stellar-starscape", null), h("copy-wrap", { class: "mv5" }, h("slot", { name: "title" }, h("h1", { class: "flex fs-massive" }, h("div", { class: "flex mr4 flex-column items-center" }, h("stellar-icon", { src: "/global/vector/mark.svg" }), h("stellar-tag", { color: "blue5", class: "mt4" }, "v", this.package && this.package.version)), h("div", null, h("h1", { class: "fw7 lh-solid theme-base0" }, "Stellar"), h("h3", { class: "db fs4 fw7 theme-complement2 w-100" }, "A Beautiful, Complete Design System"), h("stellar-code-block", { simple: true, class: "w-60", codeString: "npm install @stellar-design/core", language: "bash" }))))), h("stellar-card", null, h("stellar-grid", { compact: true }, h("stellar-select", { label: "Primary color", resize: true, onUpdate: function (e) { _this.theme = e.detail; }, size: "small", overlay: true }, h("stellar-item", { value: "red", selected: true }, "Red"), h("stellar-item", { value: "orange" }, "Orange"), h("stellar-item", { value: "yellow" }, "Yellow"), h("stellar-item", { value: "lime" }, "Lime"), h("stellar-item", { value: "green" }, "Green"), h("stellar-item", { value: "teal" }, "Teal"), h("stellar-item", { value: "cyan" }, "Cyan"), h("stellar-item", { value: "blue" }, "Blue"), h("stellar-item", { value: "indigo" }, "Indigo"), h("stellar-item", { value: "violet" }, "Violet"), h("stellar-item", { value: "fuchsia" }, "Fuchsia"), h("stellar-item", { value: "pink" }, "Pink"), h("stellar-item", { value: "gray" }, "Gray")), h("stellar-select", { label: "Secondary color", resize: true, onUpdate: function (e) { _this.complement = e.detail; }, size: "small", overlay: true }, h("stellar-item", { value: "red" }, "Red"), h("stellar-item", { value: "orange" }, "Orange"), h("stellar-item", { value: "yellow" }, "Yellow"), h("stellar-item", { value: "lime" }, "Lime"), h("stellar-item", { value: "green" }, "Green"), h("stellar-item", { value: "teal" }, "Teal"), h("stellar-item", { value: "cyan" }, "Cyan"), h("stellar-item", { value: "blue" }, "Blue"), h("stellar-item", { value: "indigo", selected: true }, "Indigo"), h("stellar-item", { value: "violet" }, "Violet"), h("stellar-item", { value: "fuchsia" }, "Fuchsia"), h("stellar-item", { value: "pink" }, "Pink"), h("stellar-item", { value: "gray" }, "Gray")))))
        ];
    };
    Object.defineProperty(DocsHeader, "watchers", {
        get: function () {
            return {
                "theme": ["handleTheming"],
...
var DocsNavigation = /** @class */ (function () {
    function DocsNavigation(hostRef) {
        registerInstance(this, hostRef);
    }
    DocsNavigation.prototype.renderItem = function (tag_name) {
        var name = tag_name.replace("stellar-", "");
...
var Markdown = /** @class */ (function () {
    ...
    class_1.prototype.onCodeStringChange = function () {
        this.convert();
    };
    class_1.prototype.onSrcChange = function () {
        this.convert();
    };
    class_1.prototype.convert = function () {
        if (this.src) {
            this.fetchMarkdown();
        }
    ...
    class_1.prototype.getMarkdown = function () {
        var raw = this.element.querySelector('template').innerHTML;
        this.raw = raw.replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;").replace(/"/g, "&quot;");
    };
    class_1.prototype.convertMarkdown = function () {
        var converted = this.showdown.makeHtml(this.raw);
    ...
    class_1.prototype.fetchMarkdown = function () {
    ...
    class_1.prototype.render = function () {
        var _this = this;
        if (this.editable) {
            return h("stellar-card", null, h("section", null, h("copy-wrap", { full: true, class: "wrap" }, h("div", { innerHTML: this.converted }))), h("footer", { class: "bg-theme-base0" }, h("stellar-input", { type: "textarea", default: this.codeString, onUpdate: function (e) { _this.codeString = e.detail; _this.convert(); } })));
        }
        else {
            return h("copy-wrap", { full: true, class: "wrap" }, h("div", { innerHTML: this.converted }));
        }
    };
    ...
    Object.defineProperty(class_1, "style", {
        get: function () { return "stellar-markdown table td,stellar-markdown table tr{border:1px solid var(--theme-base1)}"; },
        enumerable: true,
        configurable: true
    });
    return class_1;
}());
export { DocsHeader as stellar_docs_header, DocsNavigation as stellar_docs_navigation, Markdown as stellar_markdown };
