...
var animations = {
    lettering: {
        in: function (targets, delay, duration) {
        ...
        out: function (targets, delay, duration) {
            anime.timeline({ loop: false })
                .add({
                targets: Array.from(targets),
                translateX: [0, -30],
    ...
    retro: {
        in: function (targets, delay, duration) {
            anime.timeline({ loop: false })
                ...
                complete: function () {
                    var first = Array.from(targets).shift();
                    setTimeout(function () {
                ...
                .add({
                targets: Array.from(targets).map(function (el, i) {
                    if (i !== 0) {
                        return el;
                    }
...
var AnimateText = /** @class */ (function () {
    ...
    class_2.prototype.componentWillLoad = function () {
        ...
        this.letters.forEach(function (e, i) {
            properties.set({ "--iteration": ((i - 1) <= 0) ? 0 : (i - 2) }, e);
        });
    };
    class_2.prototype.in = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
...
var Blur = /** @class */ (function () {
    ...
    class_3.prototype.supported_match = function () {
        return navigator.userAgent.toLowerCase().indexOf('firefox') === -1 &&
            !(/iPad|iPhone|iPod/.test(navigator.platform));
    };
    class_3.prototype.supported = function () {
        var _this = this;
    ...
    class_3.prototype.setBlurFilter = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                properties.set({
    ...
    class_3.prototype.generateId = function () {
...
var Button = /** @class */ (function () {
    ...
    class_4.prototype.click = function () {
        return __awaiter(this, void 0, void 0, function () {
            var target, modal;
            return __generator(this, function (_a) {
                if (this.processable) {
    ...
    class_4.prototype.renderSVG = function () {
        return (h("stellar-asset", { src: "Loading", color: "white" }));
    };
    class_4.prototype.renderButton = function () {
        var _this = this;
    ...
    class_4.prototype.renderSubmit = function () {
        var _this = this;
    ...
    class_4.prototype.renderLink = function () {
        var _this = this;
    ...
    class_4.prototype.renderAppLink = function () {
        var _this = this;
    ...
    class_4.prototype.renderSpan = function () {
        var _this = this;
...
var Card = /** @class */ (function () {
    ...
    class_5.prototype.addResizeObserver = function () {
    ...
    class_5.prototype.updateFlippableCardHeight = function () {
        if (this.flippable) {
    ...
    class_5.prototype.click = function () {
        return __awaiter(this, void 0, void 0, function () {
            var target, modal;
            return __generator(this, function (_a) {
                if (this.for) {
    ...
    class_5.prototype.flip_card = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (e) {
                    e.stopPropagation();
...
var Grid = /** @class */ (function () {
    ...
    class_6.prototype.makeResponsive = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    class_6.prototype.refresh = function () {
        return __awaiter(this, void 0, void 0, function () {
            var resizeEvent;
            return __generator(this, function (_a) {
    ...
    Object.defineProperty(class_6.prototype, "element", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
...
var Layout = /** @class */ (function () {
    ...
    class_7.prototype.refresh = function () {
        return __awaiter(this, void 0, void 0, function () {
            var resizeEvent;
            return __generator(this, function (_a) {
                resizeEvent = window.document.createEvent('UIEvents');
    ...
    Object.defineProperty(class_7.prototype, "element", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
