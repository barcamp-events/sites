...
var Load = /** @class */ (function () {
    ...
    Load.prototype.database = function () {
    ...
    Load.prototype.perform = function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        _a.package = _g.sent();
                        _b = this;
                        return [4 /*yield*/, this.fetchCollection()];
                    case 2:
                        _b.collection = _g.sent();
                        _c = this;
                        return [4 /*yield*/, this.fetchDocumentation()];
                    case 3:
                        _c.documentation = _g.sent();
                        _d = this;
                        return [4 /*yield*/, this.fetchCoverage()];
                    case 4:
                        _d.coverage = _g.sent();
                        _f = this;
                        return [4 /*yield*/, this.fetchStats()];
                    case 5:
                        _f.stats = _g.sent();
    ...
    Load.prototype.fetchPackage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var pkg, request, new_pkg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.package.orderBy('version').last()];
                    case 1:
                        pkg = _a.sent();
                        return [4 /*yield*/, fetch(this.package_link)];
                    case 2:
                        request = _a.sent();
    ...
    Load.prototype.fetchCollection = function () {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(this.collection_link)];
                    case 1:
                        request = _a.sent();
                        return [4 /*yield*/, request.json()];
    ...
    Load.prototype.fetchDocumentation = function () {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(this.documentation_link)];
                    case 1:
                        request = _a.sent();
                        return [4 /*yield*/, request.json()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    Load.prototype.fetchCoverage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(this.coverage_link)];
                    case 1:
                        request = _a.sent();
                        return [4 /*yield*/, request.json()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    Load.prototype.fetchStats = function () {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(this.stats_link)];
                    case 1:
                        request = _a.sent();
                        return [4 /*yield*/, request.json()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    Load.prototype.getUsageCount = function (tag) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAllForTag(tag)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, data.documentation && data.documentation.usage && Object.keys(data.documentation.usage).length || 0];
                }
            });
        });
    };
    Object.defineProperty(Load.prototype, "components", {
        get: function () {
            return this.documentation.components.map(function (tag) { return tag.tag; });
        },
        enumerable: true,
        configurable: true
    });
    Load.prototype.getAllForTag = function (tag) {
        return __awaiter(this, void 0, void 0, function () {
            var edited_tag, data, documentation, coverage, stats;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        edited_tag = "stellar-" + tag;
                        return [4 /*yield*/, this.db.tags.where('tag').equals(edited_tag).first()];
                    case 1:
                        data = _a.sent();
                        if (!data) {
                            documentation = {};
                            coverage = [];
                            stats = {};
                            documentation = this.documentation.components.find(function (item) { return item.tag === tag; });
                            stats = this.stats.entries.find(function (item) {
                                return item.components.find(function (component) {
    ...
    Load.prototype.getVersion = function () {
...
var DocumentationRoot = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Tunnel.Provider, { state: tunnelState }, h("stencil-router", null, h("stencil-route-switch", { scrollTopOffset: 0 }, h("stencil-route", { url: '/component/:name', component: 'stellar-docs-component' }), h("stencil-route", { url: '/:name', component: 'stellar-docs-page', exact: true }), h("stencil-route", { url: '/', component: 'stellar-docs-home', exact: true }), h("stencil-route", { component: "stellar-docs-not-found" })))));
    };
...
export { DocumentationRoot as stellar_documentation };
