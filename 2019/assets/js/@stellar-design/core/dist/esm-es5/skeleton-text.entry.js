...
var SkeletonText = /** @class */ (function () {
    ...
    SkeletonText.prototype.componentWillLoad = function () {
        properties.set({
            '--width': this.width + "%"
        }, this.element);
    };
    SkeletonText.prototype.in = function () { this.element.classList.add('visible'); };
    SkeletonText.prototype.out = function () { this.element.classList.remove('visible'); };
