...
var MMCQ = (function () {
    // private constants
    var sigbits = 5, rshift = 8 - sigbits, maxIterations = 1000, fractByPopulations = 0.75;
    ...
    function quantize(pixels, maxcolors) {
        ...
        var vbox = vboxFromPixels(pixels, histo), pq = new PQueue(function (a, b) { return pv.naturalOrder(a.count(), b.count()); });
        pq.push(vbox);
...
var Picture = /** @class */ (function () {
    ...
    class_1.prototype.mountZoom = function () {
        var zoomable = this.element.shadowRoot.querySelector('img');
    ...
    class_1.prototype.handlePosterChange = function () {
        this.setBG();
    };
    class_1.prototype.handleActive = function () {
        this.setBackgroundImage();
    };
    class_1.prototype.medium = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.zoom];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.active = true;
                        if (!!this.nozoom) return [3 /*break*/, 2];
    ...
    class_1.prototype.getPictureColor = function () {
        var _this = this;
        var img = new Image(80, 80);
        img.addEventListener('load', function () {
            var cf = new ColorThief();
            _this.palette = cf.getColor(img);
            properties.set({
                "--background-color": "rgb(" + _this.palette[0] + ", " + _this.palette[1] + ", " + _this.palette[2] + ")"
            }, _this.element);
            _this.bg = "rgb(" + _this.palette[0] + ", " + _this.palette[1] + ", " + _this.palette[2] + ")";
            if (_this.zoom) {
                _this.zoom.update({
                    background: _this.bg
                });
    ...
    class_1.prototype.setBG = function () {
        if (this.bg === "auto") {
    ...
    class_1.prototype.prepareSources = function () {
        var sources = this.element.querySelectorAll("source");
        var sourcesArray = [];
        [].forEach.call(sources, function (source) {
            sourcesArray = __spreadArrays(sourcesArray, [source]);
            source.hidden = true;
        });
    ...
    class_1.prototype.setBackgroundImage = function () {
        properties.set({
            "--background-image": "url('" + (this.active ? this.large : this.poster) + "')"
        }, this.element);
    };
    class_1.prototype.updateAspectRatio = function () {
    ...
    class_1.prototype.renderPicture = function () {
        if (this.active) {
            return [
                this.sources.map(function (source) { return h("source", { srcSet: source.srcset, media: source.media ? source.media : false }); }),
    ...
    class_1.prototype.render = function () {
        ...
        if (this.type === "picture") {
            return h("figure", { itemtype: "http://schema.org/ImageObject", class: this.active ? 'loaded' : '', onClick: function () { _this.zoom && _this.zoom.open(); } }, h("div", { class: "overlay" }), h("picture", null, this.renderPicture()), h("div", { class: "placeholder", style: { "background-image": "url(" + this.poster + ")" } }), h("stellar-intersection", { element: this.element, in: this.in.bind(this) }));
        }
        else {
...
export { Picture as stellar_image };
